...
Go development environment. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `golang` or user asks by name
...
2. **Confirm tooling** - Verify `golang` runtime/CLI/MCP is available; document install if missing.
